...
import TokenListLogo from '../../assets/tokenlist.svg';
...
import { useCombinedActiveList } from '../../store/lists/hooks';
import { ChainId } from '../../interfaces/connection-config.interface';
import { AddCurrencyButtonsList } from './AddCurrencyButtonsList';
...
function CurrencyRow({
  ...
  const customAdded = useIsUserAddedToken(currency, selectedChainId);

  const balance = useCurrencyBalance(selectedChainId, account ?? undefined, currency);
    ...
    >
      ...
      <Column>
        <Text title={currency.name} fontWeight={500}>
          {currency.symbol}
          <AddCurrencyButtonsList className='show-hover' currency={currency} size={'0.8rem'} />
        </Text>
