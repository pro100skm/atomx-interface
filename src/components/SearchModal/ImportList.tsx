...
import { enableList, removeList } from '../../store/lists/actions';
          ...
          <Card style={{ backgroundColor: transparentize(0.8, theme.red1) }}>
            ...
            <AutoColumn style={{ textAlign: 'center', gap: '16px', marginBottom: '12px' }}>
              <ThemedText.Body fontWeight={500} color={theme.red1}>
                <Span>
                  By adding this list you are implicitly trusting that the data is correct. Anyone
                  can create a list, including creating fake versions of existing lists and lists
