...
export default function CurrencyInputPanel({
  ...
  const swapChainInfo = useSwapChainInfo();

  const selectedChainId =
    tokenType === IURLSwapParams.sellToken
      ? swapChainInfo.initiateChainId
      : swapChainInfo.replyChainId;
        ...
        <InputRow>
          <Grid templateRows='80% 20%'>
            <StyledNumericalInput
              ...
              $loading={loading}
            />
            {/* <Span color={theme.text3} fontWeight={'500'} fontSize={'14px'}>
              Balance:{' '}
              {selectedCurrencyBalance ? formatCurrencyAmount(selectedCurrencyBalance, 6) : 0}
            </Span> */}
            {account ? (
              <RowFixed style={{ height: '20px' }}>
                ...
                {selectedCurrencyBalance && showMaxButton ? (
          ...
          <Flex flexDirection='column' width='auto' align='flex-end' gap='0.5rem'>
            {networkSelect}
            <CurrencySelect
