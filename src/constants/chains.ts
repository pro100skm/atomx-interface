...
import { WBNB_ADDRESS, WXDC_ADDRESS } from './addresses';
...
export const DEFAULT_SELL_CHAIN_ID = ALL_SUPPORTED_CHAIN_IDS[0];
export const DEFAULT_BUY_CHAIN_ID = ALL_SUPPORTED_CHAIN_IDS[1];
export const ALL_NATIVE_CURRENCIES: NativeCurrencies[] = [
  NativeCurrencies.XDC_TEST,
  NativeCurrencies.POLYGON_TEST,
  NativeCurrencies.BSC_TEST,
  NativeCurrencies.BSC_PROD,
  NativeCurrencies.XDC_PROD,
];
export const NATIVE_CURRENCIES: { [key in ChainId]: NativeCurrencies } = {
  [ChainId.XDC_TEST]: NativeCurrencies.XDC_TEST,
  [ChainId.POLYGON_TEST]: NativeCurrencies.POLYGON_TEST,
  [ChainId.BSC_TEST]: NativeCurrencies.BSC_TEST,
  [ChainId.BSC_PROD]: NativeCurrencies.BSC_PROD,
  [ChainId.XDC_PROD]: NativeCurrencies.XDC_PROD,
};

export const WRAPPED_CURRENCIES: { [key in ChainId]: string } = {
  [ChainId.XDC_TEST]: WXDC_ADDRESS[ChainId.XDC_TEST],
  [ChainId.POLYGON_TEST]: '',
  [ChainId.BSC_TEST]: WBNB_ADDRESS[ChainId.BSC_TEST],
  [ChainId.BSC_PROD]: '',
  [ChainId.XDC_PROD]: '',
};
...
export const TOKEN_LIST_REPO: { [key in ChainId]: string } = {
  ...
  [BSC_TEST]: 'https://raw.githubusercontent.com/RomanowAgency/token-list/master',
  [BSC_PROD]: '',
  [POLYGON_TEST]: '',
};
